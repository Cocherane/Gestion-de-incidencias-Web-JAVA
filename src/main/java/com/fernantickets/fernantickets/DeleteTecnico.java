...
@WebServlet(name = "DeleteTecnico", value = "/DeleteTecnico")
public class DeleteTecnico extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // idTecnico
        int idTecnico = Integer.parseInt(request.getParameter("idTecnicoDelete"));
        ...
        }else if ( session.getAttribute("user") instanceof Admin &&  app.borraTecnico(
                // num idTecnico
                idTecnico
        )){
