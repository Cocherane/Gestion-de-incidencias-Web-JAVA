...
%>
        ...
        <div class="col-lg-12 pb-3 pb-md-4">
          <h1 class="h5 fst-italic mb-0 text-gray-600 fw-bolder text-capitalize">Resumen corto de las incidencias asignadas</h1>
        </div>

<%
      // contador para marcar el contador del modal para abrir el correcto
      int counterSetOffcanvas = 0;
      // interador de las incidecnias
  ...
  <div class="card shadow-lg border-primary">
    ...
    <div class="card-body text-light">
      ...
      <div class="d-flex justify-content-center mx-auto py-1">
        <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal_<%=counterSetOffcanvas%>" >Cerrar Incidencia</button>
      </div>
    </div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- body of form -->
        <form id="form-tecnico-close-<%=counterSetOffcanvas%>" class="formAddTask" >
          ...
          <div class="d-flex flex-row-reverse px-2 ">
            <button type="button" class="btn btn-primary m-1 shadow-lg"  onclick="setCloseIncidenctByTecnico(<%=counterSetOffcanvas%>, true )" >Reportar</button>
