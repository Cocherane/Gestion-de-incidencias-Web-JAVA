...
<%
    ...
    if ( session.getAttribute("user") != null || session.getAttribute("user") instanceof Tecnico){
        ...
        ArrayList<IncidenciaDataClass> incidenciasCerrada = app.buscarIncidenciaCerradabyTecnico( tecnico.getId() );
...
%>
                ...
                <div class="col-lg-12 pb-3 pb-md-4">
                    <h1 class="h5 fst-italic mb-0 text-gray-600 fw-bolder text-capitalize">Incidencias resueltas</h1>
                </div>
...
<div class="col" >
    <div class="card border-left-primary shadow h-100 py-5 text-center">
        <p class="h4">
            ...
            <b> NO HAS CERRADO NINGUNA INCIDENCIA AUN ...  </b>
        </p>
    </div>
</div>
<%
