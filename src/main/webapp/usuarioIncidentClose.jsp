...
<%
    ...
    if ( session.getAttribute("user") != null || session.getAttribute("user") instanceof Usuario ){
        ...
        ArrayList<IncidenciaDataClass> incidenciasCerradas = app.buscarIncidenciasCerradasbyUsuario(usuario.getId() );
...
%>
                ...
                <div class="col-lg-12 pb-3 pb-md-4">
                    <h1 class="h5 fst-italic mb-0 text-gray-600 fw-bolder text-capitalize">Incidencias reportadas resueltas</h1>
                </div>
...
<div class="col" >
    <div class="card border-left-primary shadow h-100 py-5 text-center">
        <p class="h4">
            ...
            <b> NO HAY INCIDENCIAS REPORTADAS RESUELTAS ..  </b>
        </p>
    </div>
</div>
<%
